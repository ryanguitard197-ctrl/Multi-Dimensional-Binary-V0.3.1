...
export class WasmSparseRegister {
     ...
     */
    fidelity(other: WasmSparseRegister): number;
    /**
     ...
     */
    fork(): WasmSparseRegister;
    fredkin(control: number, t1: number, t2: number): void;
    /**
     * Create from a bit string (e.g. [1, 0, 1, 1]).
     */
    static fromBits(bits: Uint8Array, name: string): WasmSparseRegister;
    /**
     * Create from an integer basis state |value⟩.
     */
    static fromInt(n: number, value: bigint, name: string): WasmSparseRegister;
    /**
     * Grover diffusion operator.
     */
    groverDiffusion(): void;
    hadamard(k: number): void;
    /**
     ...
     */
    measurePosition(k: number, seed: bigint): string;
    /**
...
export interface InitOutput {
    ...
    readonly __wbg_wasmsparseregister_free: (a: number, b: number) => void;
    ...
    readonly wasmsparseregister_autoPrune: (a: number) => number;
    readonly wasmsparseregister_cascadeSnapshot: (a: number) => [number, number];
    readonly wasmsparseregister_cnot: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_controlledPhase: (a: number, b: number, c: number, d: number) => void;
    readonly wasmsparseregister_cz: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_fidelity: (a: number, b: number) => number;
    readonly wasmsparseregister_fork: (a: number) => number;
    readonly wasmsparseregister_fredkin: (a: number, b: number, c: number, d: number) => void;
    readonly wasmsparseregister_fromBits: (a: number, b: number, c: number, d: number) => number;
    readonly wasmsparseregister_fromInt: (a: number, b: bigint, c: number, d: number) => [number, number, number];
    readonly wasmsparseregister_groverDiffusion: (a: number) => void;
    readonly wasmsparseregister_hadamard: (a: number, b: number) => void;
    readonly wasmsparseregister_hilbertDim: (a: number) => [number, number];
    readonly wasmsparseregister_inverseQft: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_measureAll: (a: number, b: bigint) => [number, number];
    readonly wasmsparseregister_measurePosition: (a: number, b: number, c: bigint) => [number, number];
    readonly wasmsparseregister_memoryBytes: (a: number) => number;
    readonly wasmsparseregister_n: (a: number) => number;
    readonly wasmsparseregister_new: (a: number, b: number, c: number) => [number, number, number];
    readonly wasmsparseregister_normalize: (a: number) => void;
    readonly wasmsparseregister_pauliX: (a: number, b: number) => void;
    readonly wasmsparseregister_pauliY: (a: number, b: number) => void;
    readonly wasmsparseregister_pauliZ: (a: number, b: number) => void;
    readonly wasmsparseregister_peek: (a: number) => [number, number];
    readonly wasmsparseregister_phase: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_population: (a: number) => number;
    readonly wasmsparseregister_probabilities: (a: number) => [number, number];
    readonly wasmsparseregister_prune: (a: number, b: number) => number;
    readonly wasmsparseregister_qft: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_reset: (a: number) => void;
    readonly wasmsparseregister_rx: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_ry: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_rz: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_sGate: (a: number, b: number) => void;
    readonly wasmsparseregister_sampleAll: (a: number, b: bigint) => [number, number];
    readonly wasmsparseregister_sparsity: (a: number) => number;
    readonly wasmsparseregister_swap: (a: number, b: number, c: number) => void;
    readonly wasmsparseregister_tGate: (a: number, b: number) => void;
    readonly wasmsparseregister_toffoli: (a: number, b: number, c: number, d: number) => void;
    readonly wasmsparseregister_totalProbability: (a: number) => number;
